...
<select id="sparebox_engine_dropdown"><option>Engine Type</option></select>
<a href="/projects/sparebox/sparebox/filtered" class="button product_type_simple add_to_cart_button ajax_add_to_cart">GO</a>
