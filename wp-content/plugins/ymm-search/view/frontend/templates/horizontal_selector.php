...
?>
<div class="widget ymm-selector ymm-horizontal" id="ymm_selector_horizontal_<?php echo $this->getWidgetId(); ?>">
...
<script>
  jQuery(function($){
    $('#ymm_selector_horizontal_<?php echo $this->getWidgetId(); ?>').ymm({
